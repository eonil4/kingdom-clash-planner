...
import SortableTableHeader from '../../../../src/components/manage/SortableTableHeader';
...
describe('SortableTableHeader', () => {
  ...
  it('should show ascending arrow when sorted ascending', () => {
    ...
    // Check for ArrowUpwardIcon (ascending) - MUI icons render as SVG
  ...
  it('should show descending arrow when sorted descending', () => {
    ...
    // Check for ArrowDownwardIcon (descending) - MUI icons render as SVG
    const svgIcons = container.querySelectorAll('svg');
    expect(svgIcons.length).toBeGreaterThan(0);
    const header = screen.getByText('Name').closest('th');
    expect(header).toBeInTheDocument();
  ...
  it('should not show arrow when column is not sorted', () => {
    ...
    const header = screen.getByText('Name').closest('th');
    expect(header).toBeInTheDocument();
    // Arrow should not be visible for this column - check that no SVG icons are in the header
