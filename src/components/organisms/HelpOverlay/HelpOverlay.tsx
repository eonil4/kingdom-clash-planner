        ...
        <Box className="space-y-6">
          ...
          <Box>
            ...
            <Box className="mb-4">
              ...
              <Typography variant="body2" className="mb-1">
                • <strong>Search:</strong> Filter units by name, rarity (Common, Rare, Epic, Legendary), and role (Human, Mages, Ranger, Support, Tank, Trickster, Undead). Multiple words use AND logic (e.g., "mage tank" finds Stone Golem, Phoenix and Lava Golem units).
              </Typography>
              <Typography variant="body2" className="mb-1">
